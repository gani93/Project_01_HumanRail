...
public class ReservationDeleteListFormAction implements Action {

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String url = "Reservation/reservationDeleteForm.jsp";
		...
		if (user == null) {
			...
			List<ReservationVO> list =  reservationDAO.getListReservation(user.getId(),0);
